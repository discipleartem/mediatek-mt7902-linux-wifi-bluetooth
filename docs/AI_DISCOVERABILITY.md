...
This repository includes machine-oriented entry points so coding agents and LLM tools can match user symptoms to this fix:
...
```bash
./scripts/set-github-discoverability.sh
```
